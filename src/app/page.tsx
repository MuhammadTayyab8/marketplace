...
export default function Home() {
  return (
    <div>
      {/* hero section start*/}
      <section className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: `url(${hero.src})` }}>
        <div className="relative z-8 flex items-center justify-end h-full px-4 md:px-10">
...
{/* Slider Start */}
<div className="relative flex flex-wrap md:flex-nowrap justify-between items-center gap-6 px-6 md:pl-20 py-8 bg-[#FCF8F3] mt-8 w-full h-auto overflow-hidden">
  {/* Left Section */}
