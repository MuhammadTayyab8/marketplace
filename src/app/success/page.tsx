...
const page = ({
    ...
    <div className='h-screen'>
        <div className="fixed inset-0 bg-white h-screen flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6 w-[90%] max-w-lg">
